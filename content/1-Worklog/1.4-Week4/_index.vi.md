...
| 5   | - Tìm hiểu các thư viện dùng để hiển thị lịch sự kiện như `react-big-calendar`. \newline - Xây dựng trang Calendar kèm các chức năng: chuyển đổi chế độ xem ngày, tuần, tháng (sau này đã bỏ và chỉ hiện theo tháng), xem chi tiết công việc kèm bật hộp thoại chỉnh sửa khi click vào lịch | 25/06/2026 | 25/06/2026 |
