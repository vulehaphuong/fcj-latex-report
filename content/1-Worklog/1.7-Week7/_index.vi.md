...
| --- | --- | --- | --- | --- |
| 2 | - Cùng nhóm kiểm thử toàn bộ Chức năng, kiểm tra log và database. <br> - Tập hợp các góp ý về lỗi hiển thị, layout chưa ưng ý, điểm thao tác chưa mượt, một số lỗi về lưu dữ liệu. | 13/07/2026 | 13/07/2026 |  |
