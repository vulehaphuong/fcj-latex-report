...
2. Tại mục **Origin**:
   * **Origin domain:** Nhấp vào ô trống và chọn tên S3 Bucket ta vừa tạo ở bước 5.3.1.
...
5. Ngay sau khi Distribution được tạo thành công, CloudFront sẽ hiển thị một thanh thông báo màu xanh lam (Banner) ở phía trên cùng, yêu cầu ta cập nhật **S3 bucket policy**.
